...
private:
  ...
  void assemble_matrix(
      FullMatrix<double>& cell_matrix, FEValues<dim>& fe_values, const double tau, const unsigned int q);
...
void StokesPSPG<dim>::run()
{
  ...
  output_results(
      this->output_dir, triangulation, dof_handler, solution_global, mpi_comm, 0);
